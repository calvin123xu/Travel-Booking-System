          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              ...
              <LinkContainer to="/Activities">
                <Nav.Link>
                  <i className="fas fa-umbrella-beach"></i>Activities
                </Nav.Link>
              </LinkContainer>
              <LinkContainer to="/Premade Packages">
                <Nav.Link>
                  <i className="fas fa-book-atlas"></i>Premade Packages
                </Nav.Link>
              </LinkContainer>
              ...
              <LinkContainer to="/Custom Package">
                <Nav.Link>
                  <i className="fas fa-user"></i>Custom Package
                </Nav.Link>
              </LinkContainer>
            </Nav>
          </Navbar.Collapse>
