...
class Package(models.Model):
   ...
   #activities = models.TextField(null=True, blank=True) -- replaced, be sure to modify 
   #the frontend code to get the description of the activity something like 
   ...
   Hotel = models.ManyToManyField(Hotel, related_name='packages')
